...
function getData() {
    ...
    if (nombre == "" || email == "" || mensaje == "") {
        ...
        document.write("</div>");
        document.write(
            '<p class="frase4">Gracias por su inscripción, le<br/>saluda Ronald Santillan</p>'
        );
        document.write(
            '<p class="frase1"> ' +
            nombre +
            " revise su e-mail " +
            email +
            " para confirmar su registro </p>"
        );
        document.write(
            '<p class="frase2">gracias por su comentario  ' + mensaje + "</p>"
        );
